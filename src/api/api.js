import {api, axiosDefault as axios} from './create-api.js'
...
export function fetchApi (req) {
  ...
  const API_URL = 'https://api.getmodel.com/api' + '/' + REQUEST_URI
  ...
  return axios.request({
    method: req.method,
    url: API_URL,
    data: (req.method === 'post') ? querystring.stringify(req.data) : {}
  }).then((response) => {
